...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ycp30j8f38-1.0.0/BotResponse" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BotResponse implements Serializable, Cloneable, StructuredPojo {
    ...
    public BotResponse messages(Message... messages) {
    ...
    public BotResponse messages(java.util.Collection<Message> messages) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BotResponse == false)
            return false;
        BotResponse other = (BotResponse) obj;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        sdk.model.transform.BotResponseMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
